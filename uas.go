...
// UAs type is the synonym for slice of User-Agents. It's the main structure you
// will use unless you want to construct your own patterns set with custom
// properties.
type UAs []*UA

// ReadUAsFromCSV loads UAs from the given CSV file. CSV file must be sanitized
// before loading in such manner that first 4 lines of CSV were deleted.
//
// For example, these lines must be deleted:
...
// the lengths of User-Agent Pattern and a User-Agent string as the parameter
// for comparing.
